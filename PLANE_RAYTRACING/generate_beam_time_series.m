function [beam_time, beam_elevation, beam_id, beam_vertical_correction] = generate_beam_time_series(start_time, end_time)
    ...
    beam_time = beam_id*2.304e-6 + repelem(beam_number, 16, 1)*55.296e-6 + start_time;
